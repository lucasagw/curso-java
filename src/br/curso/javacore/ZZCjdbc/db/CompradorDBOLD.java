...
public class CompradorDBOLD {
    ...
    public static void updateRowSet(Comprador comprador) { // não funciona mais!!! *****
        if (comprador == null || comprador.getId() == null) {
            System.out.println("Não foi possível atualizar o registro");
            return;
        ...
        try {
            ...
            jrs.execute();
            jrs.next(); //andar para primeira posição
    ...
    public static void updateRowSetCached(Comprador comprador) { // não é conectado, trabalha em memória e depois conecta e atualiza.
        if (comprador == null || comprador.getId() == null) {
            System.out.println("Não foi possível atualizar o registro");
            return;
        ...
        try {
            ...
            crs.execute();
            crs.next(); //andar para primeira posição
